 ...
 */
public class SaveSexUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveSexUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveSex(params[0]);
    }
}
