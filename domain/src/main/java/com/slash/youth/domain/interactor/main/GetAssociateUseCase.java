 ...
 */
public class GetAssociateUseCase extends UseCase<AssociateBean> {
    MainRepository repository;

    @Inject
    public GetAssociateUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
        super(threadExecutor, postExecutionThread);
        this.repository = repository;
    }

    @Override
    protected Observable<AssociateBean> buildUseCaseObservable() {
        return repository.getAssociate(params[0]);
    }
}
