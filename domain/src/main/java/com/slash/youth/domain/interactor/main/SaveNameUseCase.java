 ...
 */
public class SaveNameUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveNameUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveName(params[0]);
    }
}
