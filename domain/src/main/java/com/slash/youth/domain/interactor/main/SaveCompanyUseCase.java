 ...
 */
public class SaveCompanyUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveCompanyUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveCompany(params[0]);
    }
}
