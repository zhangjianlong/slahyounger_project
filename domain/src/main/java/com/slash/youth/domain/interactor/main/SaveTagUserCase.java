 ...
 */
public class SaveTagUserCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveTagUserCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveTag(params[0]);
    }
}
