 ...
 */
public class SaveInfoUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveInfoUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveInfo(params[0]);
    }
}
