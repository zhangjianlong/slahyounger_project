 ...
 */
public class SetTimeUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SetTimeUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.setTimeStatus(params[0]);
    }
}
