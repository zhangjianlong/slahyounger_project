 ...
 */
public class UserAgreeFriendUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public UserAgreeFriendUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.agreeFriend(params[0]);
    }
}
