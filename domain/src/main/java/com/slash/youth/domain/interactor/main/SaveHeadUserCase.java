 ...
 */
public class SaveHeadUserCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SaveHeadUserCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.saveHead(params[0]);
    }
}
