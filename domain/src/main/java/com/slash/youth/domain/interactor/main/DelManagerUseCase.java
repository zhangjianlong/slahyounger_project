 ...
 */
public class DelManagerUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public DelManagerUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.delManager(params[0]);
    }
}
