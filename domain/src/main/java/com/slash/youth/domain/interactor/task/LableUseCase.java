 ...
 */
public class LableUseCase extends UseCase<List<LabelBean>> {
    TaskRepository repository;

    @Inject
    public LableUseCase(TaskRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
