 ...
 */
public class SearchDataUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public SearchDataUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.searchData(params[0]);
    }
}
