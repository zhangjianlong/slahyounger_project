 ...
 */
public class FriendStatusUseCase extends UseCase<StatusBean> {
    MessageRepository repository;

    @Inject
    public FriendStatusUseCase(MessageRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.friendStatus(params[0]);
    }
}
