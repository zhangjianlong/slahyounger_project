 ...
 */
public class UserAddFriendUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public UserAddFriendUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.addFriend(params[0]);
    }
}
