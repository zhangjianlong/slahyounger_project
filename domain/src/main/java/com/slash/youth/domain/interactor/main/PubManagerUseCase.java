 ...
 */
public class PubManagerUseCase extends UseCase<StatusBean> {
    MainRepository repository;

    @Inject
    public PubManagerUseCase(MainRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<StatusBean> buildUseCaseObservable() {
        return repository.pubManager(params[0]);
    }
}
