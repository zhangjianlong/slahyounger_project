...
package com.core.op.lib.weight.progress;
...
public class Progress {
    ...
    public Progress(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.app_progress_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
    ...
    /**
     * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code Progress.create(Context context)}).
     *
     * @param context Activity context that the HUD bound to
     * @param style   One of the Progress.Style values
     * @return An unique HUD instance
     */
    public static Progress create(Context context, Style style) {
        return new Progress(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public Progress setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public Progress setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public Progress setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public Progress setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public Progress setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public Progress setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public Progress setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public Progress setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public Progress setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public Progress setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public Progress setAutoDismiss(boolean isAutoDismiss) {
